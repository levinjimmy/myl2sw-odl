 ...
 */
package org.lab406.com.cli.commands;
...
public class Myl2swCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(Myl2swCliTestCommand.class);
    protected final Myl2swCliCommands service;

    public Myl2swCliTestCommand(final Myl2swCliCommands service) {
